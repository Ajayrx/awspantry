  ...
  return (
    <div className="min-h-[100dvh] w-full flex flex-col md:flex-row bg-background font-sans overflow-x-hidden">
      ...
      <div className="w-full md:w-1/2 lg:w-2/5 flex flex-col min-h-[100dvh] md:min-h-0">
        <MobileAuthHeader title="Welcome back" subtitle="Log in to your SmartPantry" />
        ...
        <div className="flex-1 flex flex-col justify-start md:justify-center px-5 md:px-12 lg:px-16 pb-8 md:pb-12 pt-2 md:pt-0 w-full max-w-md mx-auto md:max-w-none">
          <div className="hidden md:block mb-8">
            <h1 className="text-4xl font-black text-text tracking-tight mb-2">Log In</h1>
            <p className="text-muted font-bold text-lg">Access your kitchen from anywhere.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="neo-button w-full py-4 text-lg mt-2 flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed"
            >
          ...
          <div className="mt-8 text-center pb-safe">
            <p className="text-muted font-bold text-sm md:text-base">
              ...
              <Link to="/signup" className="text-primary hover:text-primary-dark hover:underline">
                Sign Up
              </Link>
            </p>
          </div>
